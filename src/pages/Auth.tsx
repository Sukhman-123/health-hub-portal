      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: "Welcome to MediCare. You are now logged in.",
          });
          navigate("/");
        }
      }
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-primary-foreground">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-14 h-14 rounded-2xl gradient-secondary flex items-center justify-center shadow-glow">
              <Activity className="w-8 h-8" />
            </div>
            <div>
              <h1 className="text-3xl font-bold">MediCare</h1>
              <p className="text-primary-foreground/70">Healthcare Portal</p>
            </div>
          </div>
